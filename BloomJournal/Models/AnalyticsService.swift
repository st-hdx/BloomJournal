...
/// ファネル計測。「ビジョンを書いた人のうち何人がPro解放まで辿り着いたか」を知るためだけに入れている。
///
/// 送るのはイベント名だけで、**書いたビジョンや日々の記録の本文は一切送らない**。
...
final class Analytics {
    ...
    private let appName = "bloom-journal"
...
enum AnalyticsEvent {
    ...
    static let visionCreated = "vision_created"              // ビジョンを1つ立てた
    static let detailWritten = "detail_written"              // ビジョンに書き足した(日々の記録)
    static let freeLimitHit = "free_limit_hit"               // 無料2件の上限に当たった
    static let paywallShown = "paywall_shown"                // (trigger: add_button / onboarding / notification)
